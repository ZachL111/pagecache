"""Regression checks for the pagecache casebook."""
...
from casebook.harness import assert_expected, pagecache_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(pagecache_summary(), assert_expected())
